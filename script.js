...
products.forEach(({name , id, price, category})=>{   /// adding UI
    ...
    dessertCards.innerHTML += `
        <div class="dessert-card">
            ...
            <button id="${id}" class="btn btn-add-to-cart-btn">Add to cart</button>
        </div>
...
class ShoppingCart  {
    ...
    addItem(id, products){
        ...
        const currentProductCount = totalCountPerProduct[product.id]; /// returning value (number of products)
...
clearCartBtn.addEventListener("click", cart.clearCart.bind(cart)) ///clear cart 